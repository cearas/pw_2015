<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPageAdmin.master" AutoEventWireup="true" CodeFile="insertPet.aspx.cs" Inherits="Admin_insertPet" %>
    ...
    <asp:ValidationSummary ID="validationPet" runat="server" />
            ...
            <table>
                ...
                <tr>
                    <td>User: </td>
                    <td>
                        <asp:DropDownList ID="droplist_User" runat="server"></asp:DropDownList>
                    </td>
                </tr>    
                <tr><td></td></tr>
                <tr>
