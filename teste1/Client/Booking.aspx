<%@ Page Title="" Language="C#" MasterPageFile="~/Client/MP_Client.master" AutoEventWireup="true" CodeFile="Booking.aspx.cs" Inherits="Client_Booking" %>
		        ...
		        <div id="header" class="container">
			        <div id="menu">
				        ...
				        <ul>					        
                            ...
                            <li class="current_page_item"><asp:HyperLink ID="Booking" runat="server" NavigateUrl="~/Client/Booking.aspx">Booking</asp:HyperLink></li>
            ...
            <table>                
                <tr>
                    ...
                    <td>
                        ...
                        <asp:DropDownList ID="droplist_pets" runat="server">
                        </asp:DropDownList>
